...
if ($data['id'] != $GLOBALS['_SITE']['IdUser'])
{
	...
	echo '<button class="button btBlueTest overlayW btMedium"><img src="' . IMG . 'action/send_message.png" height="16" width="16" /> ' . __("Send a private message") . '</button> ';
...
echo '<li class="couleur1"><span>' . __('Last online') . " </span>" . $data['user']['date_last_connected'] . "</li>";
echo '<li class="couleur2"><span>' . __('Registered on') . " </span>" . $data['user']['date_created'] . "</li>";
echo '</ul>';
